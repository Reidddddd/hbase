...
final public class MetricsCoprocessor {

  private MetricsCoprocessor() {}
  ...
  @VisibleForTesting
  public static MetricRegistryInfo createRegistryInfoForMasterCoprocessor(String clazz) {
  ...
  @VisibleForTesting
  public static MetricRegistryInfo createRegistryInfoForRSCoprocessor(String clazz) {
    return new MetricRegistryInfo(
