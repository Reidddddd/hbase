...
public class TColumnFamilyDescriptor implements org.apache.thrift.TBase<TColumnFamilyDescriptor, TColumnFamilyDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TColumnFamilyDescriptor> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> configuration; // optional
  ...
  public TColumnFamilyDescriptor(TColumnFamilyDescriptor other) {
    ...
    if (other.isSetConfiguration()) {
      java.util.Map<String, String> __this__configuration = new java.util.HashMap<String, String>(other.configuration);
  ...
  public TColumnFamilyDescriptor setConfiguration(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> configuration) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case CONFIGURATION:
      if (value == null) {
        ...
        setConfiguration((java.util.Map<String, String>)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TColumnFamilyDescriptor struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configuration = new java.util.HashMap<String, String>(2*_map146.size);
                @org.apache.thrift.annotation.Nullable String _key147;
                @org.apache.thrift.annotation.Nullable String _val148;
          ...
          case 5: // BLOOMN_FILTER_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.bloomnFilterType = TBloomFilterType.findByValue(iprot.readI32());
          ...
          case 6: // COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compressionType = TCompressionAlgorithm.findByValue(iprot.readI32());
          ...
          case 8: // DATA_BLOCK_ENCODING
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.dataBlockEncoding = TDataBlockEncoding.findByValue(iprot.readI32());
          ...
          case 9: // KEEP_DELETED_CELLS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.keepDeletedCells = TKeepDeletedCells.findByValue(iprot.readI32());
      ...
      if (struct.configuration != null) {
        if (struct.isSetConfiguration()) {
          oprot.writeFieldBegin(CONFIGURATION_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter151 : struct.configuration.entrySet())
            {
      ...
      if (struct.isSetConfiguration()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter153 : struct.configuration.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.configuration = new java.util.HashMap<String, String>(2*_map158.size);
          @org.apache.thrift.annotation.Nullable String _key159;
          @org.apache.thrift.annotation.Nullable String _val160;
