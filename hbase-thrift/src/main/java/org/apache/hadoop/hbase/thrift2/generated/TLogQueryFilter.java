...
public class TLogQueryFilter implements org.apache.thrift.TBase<TLogQueryFilter, TLogQueryFilter._Fields>, java.io.Serializable, Cloneable, Comparable<TLogQueryFilter> {
  ...
  public @org.apache.thrift.annotation.Nullable String clientAddress; // optional
  ...
  public TLogQueryFilter setRegionName(@org.apache.thrift.annotation.Nullable String regionName) {
  ...
  public TLogQueryFilter setClientAddress(@org.apache.thrift.annotation.Nullable String clientAddress) {
  ...
  public TLogQueryFilter setTableName(@org.apache.thrift.annotation.Nullable String tableName) {
  ...
  public TLogQueryFilter setUserName(@org.apache.thrift.annotation.Nullable String userName) {
  ...
  public int compareTo(TLogQueryFilter other) {
    ...
    lastComparison = Boolean.valueOf(isSetFilterByOperator()).compareTo(other.isSetFilterByOperator());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFilterByOperator()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TLogQueryFilter struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // LOG_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.logType = TLogType.findByValue(iprot.readI32());
          ...
          case 7: // FILTER_BY_OPERATOR
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.filterByOperator = TFilterByOperator.findByValue(iprot.readI32());
