...
public class TAccessControlEntity implements org.apache.thrift.TBase<TAccessControlEntity, TAccessControlEntity._Fields>, java.io.Serializable, Cloneable, Comparable<TAccessControlEntity> {
  ...
  public @org.apache.thrift.annotation.Nullable String actions; // required
  public @org.apache.thrift.annotation.Nullable TTableName tableName; // optional
  public @org.apache.thrift.annotation.Nullable String nsName; // optional
  ...
  public TAccessControlEntity setUsername(@org.apache.thrift.annotation.Nullable String username) {
    this.username = username;
    return this;
  }
  ...
  public TAccessControlEntity setActions(@org.apache.thrift.annotation.Nullable String actions) {
    this.actions = actions;
    return this;
  }
  ...
  public TAccessControlEntity setNsName(@org.apache.thrift.annotation.Nullable String nsName) {
    this.nsName = nsName;
    return this;
  }
  ...
  public int compareTo(TAccessControlEntity other) {
    ...
    lastComparison = Boolean.valueOf(isSetNsName()).compareTo(other.isSetNsName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNsName()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAccessControlEntity struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // OP
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.op = TPermissionOps.findByValue(iprot.readI32());
