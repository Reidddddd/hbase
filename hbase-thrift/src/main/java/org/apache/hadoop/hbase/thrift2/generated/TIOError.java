 ...
 */
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2021-03-24")
public class TIOError extends org.apache.thrift.TException implements org.apache.thrift.TBase<TIOError, TIOError._Fields>, java.io.Serializable, Cloneable, Comparable<TIOError> {
  ...
  public int compareTo(TIOError other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCanRetry()).compareTo(other.isSetCanRetry());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCanRetry()) {
