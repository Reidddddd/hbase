...
public class FastPathRpcHandler extends RpcHandler {
  ...
  FastPathRpcHandler(String name, double handlerFailureThreshhold, Queue<CallRunner> q,
      AtomicInteger activeHandlerCount, AtomicInteger failedHandlerCount, int handlerCount,
      Abortable abortable, Deque<FastPathRpcHandler> fastPathHandlerStack) {
    super(name, handlerFailureThreshhold, q, activeHandlerCount, failedHandlerCount, handlerCount,
        abortable);
