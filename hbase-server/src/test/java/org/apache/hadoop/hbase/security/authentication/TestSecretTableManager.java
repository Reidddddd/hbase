...
public class TestSecretTableManager {
  private static final Logger LOG = LoggerFactory.getLogger(TestSecretTableManager.class);
  private static final HBaseTestingUtility TEST_UTIL = new HBaseTestingUtility();

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSecretTableManager.class);
  ...
  public void testSecretTableInitialization() throws Exception {
    ...
    assertEquals(SecretCryptoType.values().length, num);
    TEST_UTIL.shutdownMiniCluster();
  }
}
