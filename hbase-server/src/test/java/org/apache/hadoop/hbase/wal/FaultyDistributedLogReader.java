...
public class FaultyDistributedLogReader extends DistributedLogReader {
  private static final Log LOG = LogFactory.getLog(FaultyDistributedLogReader.class);
