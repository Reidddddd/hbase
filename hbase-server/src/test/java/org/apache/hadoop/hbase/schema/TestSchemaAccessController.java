...
public class TestSchemaAccessController {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSchemaAccessController.class);
  ...
  public static void setUpBeforeClass() throws Exception {
    UTIL.getConfiguration().set(REGION_COPROCESSOR_CONF_KEY,
      SchemaService.class.getName() + "," + SchemaAccessController.class.getName());
  ...
  @Test
  public void testNormalSchemaAccess() throws Throwable {
    ...
    SecureTestUtil.grantOnTable(UTIL, foo.getShortName(), tableName, null, null,
