...
public class TestSchema {
  ...
  public void TestUpdateColumnTypeOnClientSide() throws IOException, InterruptedException {
    ...
    Assert.assertTrue(Bytes.equals(TEST_FAMILY_1, column1.getFamy().cloneContent()));
    Assert.assertTrue(Bytes.equals(TEST_QUALIFIER_ONE, column1.getQualy().cloneContent()));
    Assert.assertEquals(ColumnType.NONE, column1.getType());
    Column column2 = schema.getColumn(TEST_FAMILY_1, TEST_QUALIFIER_TWO);
    Assert.assertTrue(Bytes.equals(TEST_FAMILY_1, column2.getFamy().cloneContent()));
    Assert.assertTrue(Bytes.equals(TEST_QUALIFIER_TWO, column2.getQualy().cloneContent()));
