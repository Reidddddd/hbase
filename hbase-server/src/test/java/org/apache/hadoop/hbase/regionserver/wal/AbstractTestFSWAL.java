...
public abstract class AbstractTestFSWAL {
  ...
  protected static Path WAL_ROOT_DIR;
  ...
  public void setUp() throws Exception {
    ...
    ROOT_DIR = TEST_UTIL.createRootDir();
    WAL_ROOT_DIR = TEST_UTIL.createWALRootDir();
    DIR = new Path(WAL_ROOT_DIR, currentTest.getMethodName());
    assertNotEquals(ROOT_DIR, WAL_ROOT_DIR);
  }
  ...
  public void testWALComparator() throws Exception {
    ...
    try {
      ...
      walMeta = new FSHLog(FS, WAL_ROOT_DIR, DIR.toString(),
  ...
  public void testFindMemStoresEligibleForFlush() throws Exception {
    ...
    AbstractFSWAL<?> wal = newWAL(FS, WAL_ROOT_DIR, DIR.toString(),
  ...
  public void testFailedToCreateWALIfParentRenamed() throws IOException {
    ...
    AbstractFSWAL<?> log = newWAL(FS, WAL_ROOT_DIR, name,
  ...
  public void testFlushSequenceIdIsGreaterThanAllEditsInHFile() throws IOException {
    ...
    HRegion r = HRegion.createHRegion(hri, ROOT_DIR,
            TEST_UTIL.getConfiguration(), htd);
    HRegion.closeHRegion(r);
    final int countPerFamily = 10;
    final AtomicBoolean goslow = new AtomicBoolean(false);
    // subclass and doctor a method.
    AbstractFSWAL<?> wal = newSlowWAL(FS, WAL_ROOT_DIR, DIR.toString(), testName, CONF,
    ...
    HRegion region = HRegion.openHRegion(TEST_UTIL.getConfiguration(),
            TEST_UTIL.getTestFileSystem(), ROOT_DIR, hri, htd, wal);
