...
public class TestAdaptiveFastPathRWQueueRpcExecutor {
  ...
  public void testActiveHandlerCount() throws InterruptedException {
    ...
    RpcServer.Call call = Mockito.mock(RpcServer.Call.class);
    call.param = Mockito.mock(ClientProtos.ScanRequest.class);
    ...
    // Wait for the dummy callruner being executed.
    Thread.sleep(2000);
  ...
  static class DummyCallRunner extends CallRunner {
    ...
    DummyCallRunner(RpcServerInterface rpcServer, RpcServer.Call call) {
