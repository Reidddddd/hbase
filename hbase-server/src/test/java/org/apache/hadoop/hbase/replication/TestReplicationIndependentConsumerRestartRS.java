...
public class TestReplicationIndependentConsumerRestartRS {

  private static final Log LOG =
    LogFactory.getLog(TestReplicationIndependentConsumerRestartRS.class);
  ...
  @Test(timeout = 300000)
  public void testRelicationConsumerRestartRS() throws Exception {
