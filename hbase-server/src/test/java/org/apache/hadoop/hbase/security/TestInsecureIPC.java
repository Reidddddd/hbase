...
public class TestInsecureIPC {
  ...
  @Test
  public void testRpcSimpleClientAgainstSimpleServer() throws Exception {
    ...
    callSimpleRpcService(User.create(clientUgi));
  }

  @Test
  public void testKerberizedClientAgainstSimpleServer() throws Exception {
    ...
    callSimpleRpcService(User.create(ugi2));
  }

  private void callSimpleRpcService(User clientUser) throws Exception {
