...
import org.apache.hadoop.hbase.wal.TestFSHLogProvider;
...
public class TestSystemTableBasedSecretManager {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSystemTableBasedSecretManager.class);
  ...
  public void testValidCredentialDecode() throws IOException {
    ...
    Token<? extends TokenIdentifier> authToken = currentUser.getTokens().iterator().next();
