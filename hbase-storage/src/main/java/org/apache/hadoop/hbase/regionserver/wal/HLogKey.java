...
public class HLogKey extends WALKey implements Writable {
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    if (compressionContext == null || !version.atLeast(Version.COMPRESSED)) {
      ...
      this.encodedRegionName = Compressor.readCompressed(in, compressionContext.getRegionDict());
      tablenameBytes = Compressor.readCompressed(in, compressionContext.getTableDict());
    }
