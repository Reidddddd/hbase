...
public class WALCoprocessorTableProvider implements TableProvider {
  ...
  public HTableInterface createWrapper(List<HTableInterface> tableList, TableName tableName,
    ...
    return ConnectionManager.getConnectionInternal(env.getConfiguration()).getTable(tableName);
  }
