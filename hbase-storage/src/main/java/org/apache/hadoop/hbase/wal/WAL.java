...
public interface WAL extends Closeable {
   ...
   *                   unfinished compaction -- it is not an edit for memstore.
   ...
   *         being flushed; in other words, this is effectively same as a flush of all of
   *         the region though we were passed a subset of regions. Otherwise, it returns the
   *         sequence id of the oldest/lowest outstanding edit.
