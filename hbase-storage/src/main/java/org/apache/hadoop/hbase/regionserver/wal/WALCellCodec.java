...
import org.apache.hadoop.hbase.codec.AbstractCodec;
...
public class WALCellCodec extends AbstractCodec {
  ...
  static class CompressedKvEncoder extends BaseEncoder {
    ...
    public void write(Cell cell) throws IOException {
      ...
      write(cell.getRowArray(), cell.getRowOffset(), cell.getRowLength(), compression.getRowDict());
      write(cell.getFamilyArray(), cell.getFamilyOffset(), cell.getFamilyLength(),
          compression.getFamilyDict());
      write(cell.getQualifierArray(), cell.getQualifierOffset(), cell.getQualifierLength(),
          compression.getQualifierDict());
  ...
  static class CompressedKvDecoder extends BaseDecoder {
    ...
    protected Cell parseCell() throws IOException {
      ...
      // the row
      int elemLen = readIntoArray(backingArray,
        pos + Bytes.SIZEOF_SHORT, compression.getRowDict());
      checkLength(elemLen, Short.MAX_VALUE);
      pos = Bytes.putShort(backingArray, pos, (short)elemLen);
      pos += elemLen;

      // family
      elemLen = readIntoArray(backingArray,
        pos + Bytes.SIZEOF_BYTE, compression.getFamilyDict());
      checkLength(elemLen, Byte.MAX_VALUE);
      pos = Bytes.putByte(backingArray, pos, (byte)elemLen);
      pos += elemLen;

      // qualifier
      elemLen = readIntoArray(backingArray, pos, compression.getQualifierDict());
      pos += elemLen;
