...
public class HBaseAdmin implements Admin {
  ...
  public void snapshot(final byte[] snapshotName, final byte[] tableName,
    ...
    snapshot(Bytes.toString(snapshotName), TableName.valueOf(tableName),
            SnapshotDescription.Type.FLUSH, snapshotProps);
  }
  ...
  /**
    ...
    * Attempts to take a snapshot with the same name
    * (even a different type or with different parameters)
  ...
  private long getTtlFromSnapshotProps(Map<String, Object> snapshotProps) {
    return MapUtils.getLongValue(snapshotProps, "TTL", HConstants.DEFAULT_SNAPSHOT_TTL);
  }
