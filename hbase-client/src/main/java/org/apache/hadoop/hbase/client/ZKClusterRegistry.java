...
public class ZKClusterRegistry implements ClusterRegistry {
  ...
  public ZKClusterRegistry(Configuration conf) throws IOException {
    ...
    this.zk = new RecoverableZooKeeper(ZKConfig.getZKQuorumServersString(conf), zkSessionTimeout,
            null, zkRetry, zkRetryIntervalMs, maxSleepTime);
  }
