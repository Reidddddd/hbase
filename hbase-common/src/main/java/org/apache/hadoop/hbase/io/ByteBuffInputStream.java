 ...
 * Not thread safe!
 * <p>
 * Different from ByteBufferInputStream. It is server side used only.
 * ByteBufferInputStream is used in client as well.
 */
...
public class ByteBuffInputStream extends InputStream {
  ...
  public ByteBuffInputStream(ByteBuffer buf, ByteBuffPool pool) {
    this.buf = buf;
    this.pool = pool;
  }
