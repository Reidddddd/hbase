...
public final class TraceUtil {
  ...
  public static boolean addSampler(Sampler sampler) {
    ...
    return tracer != null && tracer.addSampler(sampler);
  }
  ...
  public static boolean addReceiver(SpanReceiver rcvr) {
    return tracer != null && tracer.getTracerPool().addReceiver(rcvr);
  }
  ...
  public static boolean removeReceiver(SpanReceiver rcvr) {
    return tracer != null && tracer.getTracerPool().removeReceiver(rcvr);
  }
