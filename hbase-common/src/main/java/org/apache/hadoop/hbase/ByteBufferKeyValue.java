...
/**
 * This is an implementation of {@link Cell} where the data resides in
 * off heap/ on heap ByteBuffer
 */
@InterfaceAudience.Private
public class ByteBufferKeyValue extends ByteBufferCell implements
    HeapSize, SettableSequenceId, SettableTimestamp {
