...
public class TestByteBuffPool {
  ...
  public void testClaimThenReclaim() {
    ...
    // Less than min
    ByteBuffer bb = reservoir.claimBuffer(20);
    ...
    for (int i = 0; i < 10; i++) {
      bbs[i] = reservoir.claimBuffer(60);
    }
